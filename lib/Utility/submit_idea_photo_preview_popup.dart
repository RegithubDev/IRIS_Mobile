...
import '../AppStation/Brainbox/submit_idea.dart';
import '../AppStation/Protect/Incident_report/MyPdfViewer.dart';

class SubmitPhotoPreviewDialogPopUp extends StatefulWidget {
  List<FileDetails> fileList = <FileDetails>[];

  SubmitPhotoPreviewDialogPopUp({required this.fileList});

  @override
  _SubmitPhotoPreviewDialogPopUpState createState() =>
      _SubmitPhotoPreviewDialogPopUpState(fileList);
}

class _SubmitPhotoPreviewDialogPopUpState extends State<SubmitPhotoPreviewDialogPopUp> {
  bool isPdf = false;

  List<FileDetails> m_fileList;

  _SubmitPhotoPreviewDialogPopUpState(this.m_fileList);
