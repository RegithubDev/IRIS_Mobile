...
class PendingActionsSortPopup extends StatefulWidget {
  const PendingActionsSortPopup({Key? key}) : super(key: key);

  @override
  State<PendingActionsSortPopup> createState() =>
      _PendingActionsSortPopupState();
}

class _PendingActionsSortPopupState extends State<PendingActionsSortPopup> {
  String sort_key = "";
  ...
  Widget build(BuildContext context) {
    return Dialog(
      key: const ValueKey('pendingActionDialog'),
