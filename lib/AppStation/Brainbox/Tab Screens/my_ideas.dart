...
import '../API Call/all_ideas_api_call.dart';
import '../Models/CBrainBox.dart';
import '../Sort/my_ideas_sort_popup.dart';
...
class MyIdeas extends StatefulWidget {
  ...
  @override
  State<MyIdeas> createState() => _MyIdeasState();
}
...
class _MyIdeasState extends State<MyIdeas> {
    ...
    MySharedPreferences.instance
      ...
      MySharedPreferences.instance
        ...
        MySharedPreferences.instance
            ...
            .then((session) async {
          populateAllIdeasList(session, userid, startIndex, role);
        });
      });
    });
    if (mounted == true) {
      ...
      MySharedPreferences.instance
        ...
        MySharedPreferences.instance
          ...
          MySharedPreferences.instance
            ...
            AllIdeasApiCall obj = AllIdeasApiCall(session);
            var response = await obj.callAllIdeasAPi(startIndex, userid, role);
            if (response.body == "[]") {
              if (mounted == true) {
                setState(() {
                  _hasNextPage = false;
  ...
  void populateAllIdeasList(
      String sessionId, String userId, int startIndex, String role) async {
    AllIdeasApiCall obj = AllIdeasApiCall(sessionId);
    var response = await obj.callAllIdeasAPi(startIndex, userId, role);
    if (response.body == "[]") {
      return;
    }
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        /*SizedBox( width: 90.0,
                            child: submissionDateField(cBrainBox.created_date)),*/
    ...
    return Text(
      (() {
        if (value == "") {
          ...
          // String dateTime =DateFormat("dd-MM-yyyy  hh:mm a").format(
          //         DateFormat(value).parse(value, true).toLocal());
          // return dateTime;

          return value.split("| <br> |")[0] + value.split("| <br> |")[1];

          // String dateTime= DateFormat("dd-MM-yyyy  hh:mm a").format(
          //       DateFormat(value.split("| <br> |")[0] + value.split("| <br> |")[1]).parse(value, true).toLocal());
          // return dateTime;
        }
      })(),
      style: TextStyle(
