...
class IdeasInbox extends StatefulWidget {
  const IdeasInbox({super.key});

  @override
  State<IdeasInbox> createState() => _IdeasInboxState();
}

class _IdeasInboxState extends State<IdeasInbox> {
    ...
    MySharedPreferences.instance
      ...
      MySharedPreferences.instance
        ...
        MySharedPreferences.instance
            ...
            .then((session) async {
          populateApprovedIdesaList(session, userid, startIndex, role);
        });
      });
    });
    if (mounted == true) {
  ...
  void populateApprovedIdesaList(
