...
class ApprovedIdeasSortPopup extends StatefulWidget {
  const ApprovedIdeasSortPopup({Key? key}) : super(key: key);

  @override
  State<ApprovedIdeasSortPopup> createState() => _ApprovedIdeasSortPopupState();
}

class _ApprovedIdeasSortPopupState extends State<ApprovedIdeasSortPopup> {
  String sortKey = "";
