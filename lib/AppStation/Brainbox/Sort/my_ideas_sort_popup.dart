...
class MyIdeasSortPopup extends StatefulWidget {
  const MyIdeasSortPopup({Key? key}) : super(key: key);

  @override
  State<MyIdeasSortPopup> createState() => _MyIdeasSortPopupState();
}

class _MyIdeasSortPopupState extends State<MyIdeasSortPopup> {
  String sortKey = "";
