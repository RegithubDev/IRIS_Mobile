...
class IdeasOutbox extends StatefulWidget {
  const IdeasOutbox({super.key});

  @override
  State<IdeasOutbox> createState() => _IdeasOutboxState();
}

class _IdeasOutboxState extends State<IdeasOutbox> {
