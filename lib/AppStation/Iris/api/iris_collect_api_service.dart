...
class IrisCollectAPIService {
  Future<String> collectDataApiCall(IRISCollectRequestModel requestModelCopy, String siteID) async {
    ...
    requestModelCopy.sbuCode=prefs.getString('IRIS_SBU_CODE') ?? '';
    ...
    final response = await http.post(Uri.parse(IRIS_COLLECT_DATA),
