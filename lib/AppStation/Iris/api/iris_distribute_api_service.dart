...
class IrisDistributeAPIService {
  Future<String> distributeDataApiCall(IRISDistributeRequestModel requestModelCopy, String siteID, String sbu) async {
    ...
    final response = await http.post(Uri.parse(IRIS_DISTRIBUTE_DATA),
