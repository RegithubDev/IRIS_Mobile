...
import 'c_&_t_collect_preview.dart';

class CAndTCollectScreen extends StatefulWidget {
  final String wasteType;
  final String siteID;

  const CAndTCollectScreen(
      {super.key, required this.wasteType, required this.siteID});

  @override
  State<CAndTCollectScreen> createState() => _CAndTCollectScreenState();
}

class _CAndTCollectScreenState extends State<CAndTCollectScreen> {
                  ...
                  child: GestureDetector(
                    ...
                    onTap: () {
                      ...
                      if (_quantityController.text == "" ||
                          double.parse(_quantityController.text) == 0.0) {
                        showDialog(
                            useRootNavigator: false,
                            barrierDismissible: false,
                            context: context,
