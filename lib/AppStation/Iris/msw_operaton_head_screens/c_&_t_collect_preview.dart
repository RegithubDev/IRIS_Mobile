...
import '../api/msw_cnt_collect_api_service.dart';
import '../iris_home_screen.dart';
import '../model/collect_preview_model.dart';
import '../model/iris_collect_model.dart';

class CAndTCollectPreviewScreen extends StatefulWidget {
  final CollectPreviewModel collectPreviewModel;

  const CAndTCollectPreviewScreen(
      {super.key, required this.collectPreviewModel});

  @override
  State<CAndTCollectPreviewScreen> createState() =>
      _CAndTCollectPreviewScreenState();
}

class _CAndTCollectPreviewScreenState extends State<CAndTCollectPreviewScreen> {
  late TextEditingController _wasteTypeController = TextEditingController();
  ...
  getInit() async {
    ...
    if (isApiCallProcess == true) {
      MSWCollectAPIService apiService = MSWCollectAPIService();
      apiService
          .mswCollectDataApiCall(irisCollectRequestModel, siteID)
          .then((value) {
