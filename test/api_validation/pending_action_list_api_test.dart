...
import 'package:resus_test/AppStation/Protect/api_call/pendingActionApiCall.dart';
import 'package:resus_test/Utility/MyHttpOverrides.dart';

void main() {
  HttpOverrides.global = MyHttpOverrides();

  group('For testing pending action list API', () {
    ...
    test('returns login response string when http response is successful',
          ...
          PendingActionApiCall pa= PendingActionApiCall("JSESSIONID=80019B916CFB2688E39718D4F45B8EDE");


          expect(await pa.unitTestCallPendingActionAPi(), "200");
        });
